...
START_TEST(test_art_insert_search)
{
    ...
    fail_unless(l && strcmp((char*)art_leaf_key(l), "A") == 0);

    // Check the maximum
    l = art_maximum(&t);
    fail_unless(l && strcmp((char*)art_leaf_key(l), "zythum") == 0);
...
START_TEST(test_art_insert_search_uuid)
{
    ...
    // Check the minimum
    art_leaf *l = art_minimum(&t);
    fail_unless(l && strcmp((char*)art_leaf_key(l), "00026bda-e0ea-4cda-8245-522764e9f325") == 0);

    // Check the maximum
    l = art_maximum(&t);
    fail_unless(l && strcmp((char*)art_leaf_key(l), "ffffcb46-a92e-4822-82af-a7190f9c1ec5") == 0);
